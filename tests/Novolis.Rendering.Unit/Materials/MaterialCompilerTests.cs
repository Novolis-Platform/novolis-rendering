...
public sealed class MaterialCompilerTests
{
    ...
    {
        var gpu = MaterialCompiler.Compile(MaterialPresets.Metal(MaterialPresets.Colors.Silver, 0.08f));
    ...
    {
        var gpu = MaterialCompiler.Compile(MaterialPresets.Glass(Vector3.One, ior: 1.52f));
